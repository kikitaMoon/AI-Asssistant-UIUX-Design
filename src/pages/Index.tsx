      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent className="bg-card text-card-foreground border-border max-w-6xl w-[80vw] h-[80vh] max-h-[80vh] p-0">
          <DialogHeader className="px-6 pt-3 pb-0">
            <DialogTitle className="text-xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              Settings
            </DialogTitle>
          </DialogHeader>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
                  ...
                  {sampleQuestions.map((item, index) => {
                    ...
                    return (
                      <button
                        ...
                        className="p-4 bg-card hover:bg-accent rounded-lg text-card-foreground text-left transition-colors duration-200 flex flex-col items-start gap-3 border border-border"
                      >
        ...
        <div className="w-full max-w-4xl mx-auto">
          <div className="relative">
            ...
            {/* Main Input Area */}
            <div className="bg-card rounded-2xl shadow-lg overflow-hidden transition-colors duration-300 border border-border">
              <textarea
                value={message}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg hover:bg-accent transition-colors duration-200 group text-muted-foreground hover:text-foreground"
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <button
                          className="p-2 rounded-lg hover:bg-accent transition-colors duration-200 group relative text-muted-foreground hover:text-foreground"
                          title="MCP Server"
                        >
                  ...
                  <button
                    onClick={handleSend}
                    disabled={!message.trim() && (!isTextCanvasOpen || !canvasContent.trim())}
                    className="p-2 rounded-lg bg-primary hover:bg-primary/90 disabled:bg-muted disabled:cursor-not-allowed transition-colors duration-200 group text-primary-foreground"
                    title="Send message"
                  >
